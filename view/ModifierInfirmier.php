...
$id=( int )$islam;
  ...
  $sql4="UPDATE infirmier SET  Nom='$nom1',Prenom='$prenom1',Lieu_naissance='$lieu1',Date_naissance='$date_N1',Adresse='$adr1',Numero_tel='$num1' ,Grade='$grade1' ,Nationalite='$nationalite1',Statut='$status1',Email='$email1',Mdp='$mdp1',Genre='$genre1' where Id=$id";
  //regarder le resultat de la requete 
   //var_dump($sql4);
  $message5=mysqli_query($con,$sql4);

  echo "<SCRIPT LANGUAGE='JavaScript'>
  document.location.href='ListesInfirmier.php'
  </SCRIPT>";
  //var_dump($message5);
